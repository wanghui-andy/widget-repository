...
DrawingBoardView::DrawingBoardView(QWidget *parent) : QGraphicsView(parent)
{
    ...
    lines << QLineF(18.542698, 459.640132, 23.650757, 463.898617) << QLineF(23.93208, 463.873175, 24.94781, 462.654663)
          << QLineF(25.15059, 462.548427, 26.311935, 462.44303) << QLineF(26.530847, 462.51122, 27.627745, 463.425678)
    ...
    {
        Param() {}
        Param(qreal xx, qreal yy, qreal a)
        {
            x = xx;
            y = yy;
            angle = a;
